...
import { COUNTRIES, FUNC } from '../util';
        ...
        <div id="sub-nav">
          <ul>
            <li className={this.isActive('account-setup')}>
              <a href="javascript:;" onClick={() => this.handleChange('account-setup')}>1. ACCOUNT SETUP</a>
            </li>
            <li className={this.isActive('subscription')}>
              <a href="javascript:;" onClick={() => this.handleChange('subscription')}>2. SUBSCRIBE A PLAN</a>
            </li>
            <li className={this.isActive('access')}>
              <a href="javascript:;" onClick={() => this.handleChange('access')}>3. CREATE ACCESS</a>
            </li>
            <li className={this.isActive('connect')}>
              <a href="javascript:;" onClick={() => this.handleChange('connect')}>4. CONNECT</a>
            </li>
          </ul>
        </div>
        {displayForm}
